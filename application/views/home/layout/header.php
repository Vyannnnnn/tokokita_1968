...
<head>
    ...
    <!-- Google Web Fonts -->
    <link rel="preconnect" href="<?php echo base_url('assets/home/https://fonts.gstatic.com'); ?>">
    <link href="<?php echo base_url('assets/home/https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap'); ?>" rel="stylesheet">

    <!-- Font Awesome -->
    <link href="<?php echo base_url('assets/home/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css'); ?>" rel="stylesheet">
        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <?php } else { ?>
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-o">
